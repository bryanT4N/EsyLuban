...
public sealed partial class ExcelFromJsonMultiRow : Luban.BeanBase
{
    public ExcelFromJsonMultiRow(JSONNode _buf) 
    {
        ...
        { var __json0 = _buf["items"]; if(!__json0.IsArray) { throw new SerializationException(); } Items = new System.Collections.Generic.List<test.TestRow>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { test.TestRow __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = global::cfg.test.TestRow.DeserializeTestRow(__e0);  }  Items.Add(__v0); }   }
    }
