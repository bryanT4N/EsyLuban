...
namespace cfg.test
{
public sealed partial class AutoImport2 : Luban.BeanBase
{
    public AutoImport2(JSONNode _buf) 
    {
    ...
    public static AutoImport2 DeserializeAutoImport2(JSONNode _buf)
    {
        return new test.AutoImport2(_buf);
    }
    ...
    public const int __ID__ = 417472770;
