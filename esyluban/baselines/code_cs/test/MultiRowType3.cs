...
public sealed partial class MultiRowType3 : Luban.BeanBase
{
    public MultiRowType3(JSONNode _buf) 
    {
        ...
        { var __json0 = _buf["items"]; if(!__json0.IsArray) { throw new SerializationException(); } Items = new System.Collections.Generic.List<test.MultiRowType1>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { test.MultiRowType1 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = global::cfg.test.MultiRowType1.DeserializeMultiRowType1(__e0);  }  Items.Add(__v0); }   }
    }
