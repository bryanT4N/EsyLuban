...
public sealed partial class TestNull : Luban.BeanBase
{
    public TestNull(JSONNode _buf) 
    {
        ...
        { var _j = _buf["x3"]; if (_j.Tag != JSONNodeType.None && _j.Tag != JSONNodeType.NullValue) { { if(!_j.IsObject) { throw new SerializationException(); }  X3 = global::dataTables.test.DemoType1.DeserializeDemoType1(_j);  } } else { X3 = null; } }
        { var _j = _buf["x4"]; if (_j.Tag != JSONNodeType.None && _j.Tag != JSONNodeType.NullValue) { { if(!_j.IsObject) { throw new SerializationException(); }  X4 = global::dataTables.test.DemoDynamic.DeserializeDemoDynamic(_j);  } } else { X4 = null; } }
