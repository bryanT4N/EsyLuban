...
public sealed partial class TestScriptableObject : Luban.BeanBase
{
    public TestScriptableObject(JSONNode _buf) 
    {
        ...
        { if(!_buf["v3"].IsObject) { throw new SerializationException(); }  V3 = ExternalTypeUtil.NewVector3(global::dataTables.vec3.Deserializevec3(_buf["v3"]));  }
        { if(!_buf["v4"].IsObject) { throw new SerializationException(); }  V4 = ExternalTypeUtil.NewVector4(global::dataTables.vec4.Deserializevec4(_buf["v4"]));  }
    }
