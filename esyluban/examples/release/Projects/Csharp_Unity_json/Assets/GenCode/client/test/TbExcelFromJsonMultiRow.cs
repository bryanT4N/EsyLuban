...
public partial class TbExcelFromJsonMultiRow
{
    ...
    public TbExcelFromJsonMultiRow(JSONNode _buf)
    {
        ...
        foreach(JSONNode _ele in _buf.Children)
        {
            ...
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.ExcelFromJsonMultiRow.DeserializeExcelFromJsonMultiRow(_ele);  }
            _dataList.Add(_v);
