...
public partial class TbTestIndex
{
    ...
    public TbTestIndex(JSONNode _buf)
    {
        ...
        _dataMap = new System.Collections.Generic.Dictionary<int, test.TestIndex>(count);
        _dataList = new System.Collections.Generic.List<test.TestIndex>(count);
        
        foreach(JSONNode _ele in _buf.Children)
        {
            test.TestIndex _v;
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.TestIndex.DeserializeTestIndex(_ele);  }
            _dataList.Add(_v);
