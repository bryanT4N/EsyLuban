...
public partial class TbTestFieldVariant2
{
    ...
    public TbTestFieldVariant2(JSONNode _buf)
    {
        int count = _buf.Count;
        _dataMap = new System.Collections.Generic.Dictionary<int, test.TestFieldVariant2>(count);
        _dataList = new System.Collections.Generic.List<test.TestFieldVariant2>(count);
        
        foreach(JSONNode _ele in _buf.Children)
        {
            test.TestFieldVariant2 _v;
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.TestFieldVariant2.DeserializeTestFieldVariant2(_ele);  }
            _dataList.Add(_v);
