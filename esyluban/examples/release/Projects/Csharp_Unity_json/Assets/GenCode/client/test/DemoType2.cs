...
public sealed partial class DemoType2 : Luban.BeanBase
{
    public DemoType2(JSONNode _buf) 
    {
        ...
        { if(!_buf["x12"].IsObject) { throw new SerializationException(); }  X12 = global::dataTables.test.DemoType1.DeserializeDemoType1(_buf["x12"]);  }
        ...
        { var __json0 = _buf["k15"]; if(!__json0.IsArray) { throw new SerializationException(); } int _n0 = __json0.Count; K15 = new test.DemoDynamic[_n0]; int __index0=0; foreach(JSONNode __e0 in __json0.Children) { test.DemoDynamic __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = global::dataTables.test.DemoDynamic.DeserializeDemoDynamic(__e0);  }  K15[__index0++] = __v0; }   }
    }
