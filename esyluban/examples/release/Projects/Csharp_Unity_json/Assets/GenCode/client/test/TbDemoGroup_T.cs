...
{
public partial class TbDemoGroup_T
{
    ...
    public TbDemoGroup_T(JSONNode _buf)
    {
        ...
        {
            test.DemoGroup _v;
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.DemoGroup.DeserializeDemoGroup(_ele);  }
            _dataList.Add(_v);
