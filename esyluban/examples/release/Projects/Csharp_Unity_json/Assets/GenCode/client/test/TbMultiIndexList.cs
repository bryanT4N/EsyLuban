...
public partial class TbMultiIndexList
{
    ...
    public TbMultiIndexList(JSONNode _buf)
    {
        ...
        _dataList = new System.Collections.Generic.List<test.MultiIndexList>(count);
        
        foreach(JSONNode _ele in _buf.Children)
        {
            test.MultiIndexList _v;
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.MultiIndexList.DeserializeMultiIndexList(_ele);  }
            _dataList.Add(_v);
        }
        _dataMap_id1 = new System.Collections.Generic.Dictionary<int, test.MultiIndexList>(count);
        _dataMap_id2 = new System.Collections.Generic.Dictionary<long, test.MultiIndexList>(count);
        _dataMap_id3 = new System.Collections.Generic.Dictionary<string, test.MultiIndexList>(count);
