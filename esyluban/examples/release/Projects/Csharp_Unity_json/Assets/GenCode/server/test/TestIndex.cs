...
public sealed partial class TestIndex : Luban.BeanBase
{
    public TestIndex(JSONNode _buf) 
    {
        ...
        { var __json0 = _buf["eles"]; if(!__json0.IsArray) { throw new SerializationException(); } Eles = new System.Collections.Generic.List<test.DemoType1>(__json0.Count); foreach(JSONNode __e0 in __json0.Children) { test.DemoType1 __v0;  { if(!__e0.IsObject) { throw new SerializationException(); }  __v0 = global::dataTables.test.DemoType1.DeserializeDemoType1(__e0);  }  Eles.Add(__v0); }   }
