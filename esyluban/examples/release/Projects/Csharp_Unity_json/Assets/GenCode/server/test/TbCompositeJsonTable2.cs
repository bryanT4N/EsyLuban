...
public partial class TbCompositeJsonTable2
{
    ...
    public TbCompositeJsonTable2(JSONNode _buf)
    {
        ...
        foreach(JSONNode _ele in _buf.Children)
        {
            ...
            { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::dataTables.test.CompositeJsonTable2.DeserializeCompositeJsonTable2(_ele);  }
            _dataList.Add(_v);
