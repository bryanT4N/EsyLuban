...
public sealed partial class SimpleParallel : ai.ComposeNode
{
    public SimpleParallel(JSONNode _buf)  : base(_buf) 
    {
        ...
        { if(!_buf["main_task"].IsObject) { throw new SerializationException(); }  MainTask = global::dataTables.ai.Task.DeserializeTask(_buf["main_task"]);  }
        { if(!_buf["background_node"].IsObject) { throw new SerializationException(); }  BackgroundNode = global::dataTables.ai.FlowNode.DeserializeFlowNode(_buf["background_node"]);  }
    }
